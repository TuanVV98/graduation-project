export default function InfoNhaSi() {
    return (
        <div>
            <div className="row border border-dark mt-5 mb-5" style={{height:'260px'}}>
                ...
                <div className="col-md-2 ms-5">
                    <div >
                        ...
                        <img id="exampleFormControlInput1" src="https://mdbootstrap.com/img/new/fluid/nature/018.jpg" className="card-img" alt="no img" style={{height: '150px',width: '150px'}}></img>
                    </div>
                </div>
                ...
                <div className="col-md-3 mb-3">
                    <div className="form-group mt-3">
                        ...
                        <input name="name" className="form-control"
                            id="name" autoComplete="off" defaultValue="Bruno"
                            type="text" readOnly />
                    </div>
                    <div className="form-group mt-3 ">
                        <label htmlFor="birthday">Ngày sinh</label>
                        <input name="birthday" className="form-control" defaultValue="07/10/1989"
